 ...
 --}}
                                <div class="hexagon-menu clear">
                                    <div class="hexagon-item">
                                        ...
                                        <a href="{{ route('profile') }}" class="hex-content">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="{{route('room')}}" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="{{route('chatuser')}}" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                    <i class="fa fa-comment"></i>
                                                </span>
                                                <span class="title">Chat private</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>    
                                    </div>
                                    <div class="hexagon-item">
                                        ...
                                        <a href="{{route('getsearch')}}" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="https://facebook.com/bo.cuaban.7169" target="_blank" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="{{ route('logout') }}" class="hex-content">
                                            <span class="hex-content-inner">
                                                <span class="icon">
